    ...
    <div class="question-container">
      ...
      <transition name="fade">
        ...
        <div v-else class="team-answers animated-answers">
          ...
          <button class="timer-button animated-button" @click="startTimer">Start timer – 5 minutes</button>
        </div>
      </transition>
    </div>
  </template>
    ...
    methods: {
      ...
      nextQuestion() {
        const pointsArray = this.teamAnswers.map(answers => {
          // Calculate points based on how many correct answers are selected
          let points = 0;
      ...
      startTimer() {
        ...
        console.log("Timer started for 5 minutes.");
      }
    }
  };
  </script>
