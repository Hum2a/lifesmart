<template>
  <div class="width">
    ...
    <div class="event-buttons-container">
      <button @click="toggleAllAnnotations" class="toggle-all-button">
...
export default {
  ...
  methods: {
        ...
        this.assetChangesChart.value = new Chart(ctx, {
          ...
          options: {
            ...
            plugins: {
              ...
              annotation: {
                annotations: this.getAnnotations(), // Use method to fetch current annotations
    ...
    toggleAllAnnotations() {
      const allVisible = Object.values(this.eventAnnotationsVisible).some(visibility => !visibility);
    ...
    updateChartAnnotations() {
      if (!this.assetChangesChart.value) return; // Ensure chart is initialized
      this.assetChangesChart.value.options.plugins.annotation.annotations = this.getAnnotations();
    },
